...
/data/ai_club/nes_2025/swag/.venv/bin/python idm/train_idm_video.py \
    --job_id $SLURM_JOB_ID \
    --embedding_dim $1 \
    --ff_dim $2 \
...
# sbatch utils/scripts/2_train_idm_alt.sh 256 256 2 4 64 60 0.0002147 0.000001 32,64,64
# /data/ai_club/nes_2025/swag/.venv/bin/python idm/train_idm_video.py \
#    --job_id 0 \
#    --embedding_dim 256 \
#    --ff_dim 256 \
