...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--stride", type=int, default=1, help="Stride for training")
...
def main() -> None:
    ...
    model.load_model(os.path.join(model_path, "best_model.pt"))
    ...
    dataset = ChunkedNumpyDataset(
        ...
        cache_type="lru",
        stride=args.stride,
        data_splits={"train": 0.95, "val": 0.05},
    )
